...
void DDTelescopePlanesAlgo::execute(DDCompactView& cpv) {
  ...
  for (int i=0; i<n; i++) {
    ...
    double ypos = 0.;
    if (i == 0) {
    	double zpos = (-20.5 - 5.0 - 13.5 - 10.2)*deltaZ/5.0;
    }
    if (i == 1) {
    	double zpos = (-20.5 - 5.0 - 13.5)*deltaZ/5.0;
    }
    if (i == 2) {
    	double zpos = (-20.5 - 5.0)*deltaZ/5.0;
    }
    if (i == 3) {
    	double zpos = -20.5*deltaZ/5.0;
    }
    if (i == 4) {
    	double zpos = 14.0*deltaZ/5.0;
    }
    if (i == 5) {
    	double zpos = (14.0 + 10.9)*deltaZ/5.0;
    }
    if (i == 6) {
    	double zpos = (14.0 + 10.9 + 12.3)*deltaZ/5.0;
    }
    if (i == 7) {
    	double zpos = (14.0 + 10.9 + 12.3 + 5.0)*deltaZ/5.0;
    }
